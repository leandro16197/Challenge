...
<button class="button-nav navbar-toggler ms-auto" type="button" data-bs-toggle="collapse" data-bs-target="#sidebar" aria-controls="sidebar" aria-expanded="false" aria-label="Toggle sidebar">
    ...
    <div class="perfil">
        <a class="nav-link text-dark">
            <i class="cil-logout"></i>{{Auth::user()->name}}
        </a>
    </div>
</nav>
